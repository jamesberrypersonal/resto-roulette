...
> **Superseded by [`phase-3-design-doc-server-workspace.md`](../phase-3-design-doc-server-workspace.md).** This document remains for historical context; decisions that were open here are locked in the phase 3 doc.
